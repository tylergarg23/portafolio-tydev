        ...
        <div class="box">
          <div class="columns_finals level">
            <div class="column_final level-item">
              <h1 class="titulo"><?php the_field('titulo_flotante');?></h1>
            </div>
            <div class="column_final level-item">
              <p><?php the_field('descripcion_flotante');?></p>
            </div>
            <div class="column_final level-item">
              <a class="button is-success is-outlined is-rounded is-medium has-text-weight-normal" href="/plan-proyecto">
                ...
                <span><?php the_field('boton_flotante');?></span>
              </a>
          </div>
          </div>
        </div>
